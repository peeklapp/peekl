...
var (
	validNameRegex         = regexp.MustCompile("^[a-zA-Z_-]+$")
	...
	validDayRegex          = regexp.MustCompile("^(3[01]|[12][0-9]|[0-9])$")
	validDayRangeRegex     = regexp.MustCompile("^(3[01]|[12][0-9]|[0-9])-(3[01]|[12][0-9]|[0-9])$")
	validMonthRegex        = regexp.MustCompile("^(1[012]|[1-9])|(JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)$")
